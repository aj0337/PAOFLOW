...
#define   __CONF_BLAS_LIBS      "-L/opt/intel/oneapi/mkl/2022.1.0/lib/intel64 -lmkl_intel_lp64 -lmkl_core -lmkl_sequential -lpthread -lm -ldl"
#define   __CONF_LAPACK_LIBS    "-L/opt/intel/oneapi/mkl/2022.1.0/lib/intel64 -lmkl_intel_lp64 -lmkl_core -lmkl_sequential -lpthread -lm -ldl"
#define   __CONF_FFT_LIBS       " -L/opt/intel/oneapi/mkl/2022.1.0/lib/intel64 -lmkl_intel_lp64 -lmkl_core -lmkl_sequential -lpthread -lm -ldl"
